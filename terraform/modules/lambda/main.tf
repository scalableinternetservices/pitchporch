...
# Lambda URIs are "{+lambda}/{+function}" e.g. "pitchporch/ping".
# We also support path matching at the root e.g. "pitchporch" but these require definining separate "_root" terraform resources.
